...
for n_terms_to_be_kept in n_terms_list:
    ...
    ax2.plot(z_resp, 1e3*x_reconstr, label=f'Reconstructed (n={n_freq})')
    ...
    ax3.plot(slices_test.z_centers, 1e6*slices_test.mean_xp, label=f'Harm. response (n={n_freq})')
