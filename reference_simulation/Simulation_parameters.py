...
sigma_z = 0.09705780827750002 #1.2e-9/4*c
...
fraction_device_dip = 7.000000e-02 #0.65
init_unif_edens_flag_dip = 1
init_unif_edens_dip = 4.000000e+11
...
folder_path = '!folder_of_this_file!/../quad_combined_distribution/'
filename_state = 'combined_distribution_sey_%.2f_VRF_4MV_intensity_%.1fe11ppb_450GeV_N_mp_%d_symm'%(sey,intensity/1e11,eMPs)
